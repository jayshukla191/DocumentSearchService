# ECS Module - Fargate cluster, service, and task definition
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name  = "AWS_BEDROCK_LLM_MODEL_ID"
          value = var.bedrock_llm_model
        },
        {
          name  = "SPRING_DATASOURCE_URL"
          value = "jdbc:postgresql://${var.db_host}/${var.db_name}?ssl=true&sslmode=require"
        },
        {
